...
module.exports = class extends Base {
  ...
  async detailAction() {
    ...
    const attribute = await this.model('goods_attribute').field('nfyx_goods_attribute.value, nfyx_attribute.name').join('nfyx_attribute ON nfyx_goods_attribute.attribute_id=nfyx_attribute.id').order({'nfyx_goods_attribute.id': 'asc'}).where({'nfyx_goods_attribute.goods_id': goodsId}).select();
